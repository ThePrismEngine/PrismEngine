...
.. _program_listing_file_PrismEngine_src_renderer.cpp:

Program Listing for File renderer.cpp
=====================================

|exhale_lsh| :ref:`Return to documentation for file <file_PrismEngine_src_renderer.cpp>` (``PrismEngine\src\renderer.cpp``)
