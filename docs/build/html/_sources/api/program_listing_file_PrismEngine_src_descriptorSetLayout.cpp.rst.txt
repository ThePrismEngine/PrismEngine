...
.. _program_listing_file_PrismEngine_src_descriptorSetLayout.cpp:

Program Listing for File descriptorSetLayout.cpp
================================================

|exhale_lsh| :ref:`Return to documentation for file <file_PrismEngine_src_descriptorSetLayout.cpp>` (``PrismEngine\src\descriptorSetLayout.cpp``)
