...
.. _program_listing_file_C__Users_Admin_source_repos_PrismEngine_src_vector.cpp:

Program Listing for File vector.cpp
===================================

|exhale_lsh| :ref:`Return to documentation for file <file_C__Users_Admin_source_repos_PrismEngine_src_vector.cpp>` (``C:\Users\Admin\source\repos\PrismEngine\src\vector.cpp``)
