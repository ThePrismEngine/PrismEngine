...
.. _program_listing_file_C__Users_Admin_source_repos_PrismEngine_src_matrix.cpp:

Program Listing for File matrix.cpp
===================================

|exhale_lsh| :ref:`Return to documentation for file <file_C__Users_Admin_source_repos_PrismEngine_src_matrix.cpp>` (``C:\Users\Admin\source\repos\PrismEngine\src\matrix.cpp``)
