...
.. _program_listing_file_PrismEngine_src_vertex.cpp:

Program Listing for File vertex.cpp
===================================

|exhale_lsh| :ref:`Return to documentation for file <file_PrismEngine_src_vertex.cpp>` (``PrismEngine\src\vertex.cpp``)
