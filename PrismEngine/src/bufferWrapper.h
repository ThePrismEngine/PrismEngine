...
namespace prism {
	namespace PGC {
		...
		public:
			...
			static void createBO(utils::Context* context, VkBuffer& buffer, size_t bufferSize, VkDeviceMemory& buferMemory, void*& bufferMapped, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties);
